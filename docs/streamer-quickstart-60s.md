...
Objectif : tester StreamVolume Guard rapidement avec un navigateur capturé dans OBS.
...
3. Clique sur `Activer cet onglet`.
...
4. Laisse StreamVolume Guard absorber les gros écarts entre vidéos, plateformes et pubs.
